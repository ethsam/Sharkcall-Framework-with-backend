        ...
        <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="lineModalLabelUpdate">Update Category</h3><span id="idUpdateCategory"></span>
                    </div>
                    ...
                    <div class="modal-footer">
                        <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                            ...
                            <div class="btn-group" role="group">
                                <button type="submit" id="btn_updateCategory" class="btn btn-success btn-hover-green" data-action="save" onclick="postUpdateCategory( $('#idUpdateCategory').text() , $('#inputUpdateDesignation').val() );" role="button">Ok</button>
                            </div>
