            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                        ...
                        <div class="btn-group" role="group">
                            <button type="submit" id="btn_addCategory" class="btn btn-success btn-hover-green" data-action="save" onclick="postAddCategory(jQuery('#inputDesignation').val());" role="button">Sauvegarder</button>
                        </div>
                    </div>
                </div>
                    <!-- </form> -->
